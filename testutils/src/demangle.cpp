...
namespace
{
    std::string generateMessage(cm::testing::DemanglingFailed::Cause cause, char const symbolName[])
    {
        using E = cm::testing::DemanglingFailed;
        
        switch (cause)
        {
        case E::success:            return "demagling succeeded";
        case E::outOfMemory:        return "demagling failed: out of memory";
        ...
        case E::invalidArgument: return "demangling failed: invalid argument";
        default: 
            {
                std::stringstream msg;
...
namespace cm
{
    namespace testing
    {
        ...
        DemanglingFailed::DemanglingFailed(Cause cause, char const symbol[]) :
           std::runtime_error(generateMessage(cause, symbol)),
           cause(cause),
           symbol(symbol)
        {            
        }
