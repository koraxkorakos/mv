...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file 
/// This file declares a function to demangle symbol names, which might e.g. be usefule to log exception type names.
///
...
namespace cm
{
    ...
    template <typename T>
    inline auto demangle_t(){ return demangle(typeid(T).name()); }
    }
}
